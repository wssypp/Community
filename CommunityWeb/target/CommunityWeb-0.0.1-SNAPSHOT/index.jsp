...
<header id="header">
  <div class="navbox">
    ...
    <div class="logo"><a href="#">千锋之家</a></div>
    <nav>
      <ul id="starlist">
        <li><a href="index.html">首页</a></li>
        <li><a href="list.html">文章</a></li>
        <li class="menu"><a href="list2.html">我的千锋</a>
          <ul class="sub">
            <li><a href="/6">空间文章</a></li>
            <li><a href="/7">论坛问答</a></li>
              <!--<li><a href="/8">回答</a></li>-->
         
             <!--<li><a href="/8">心得笔记</a></li>-->
          </ul>
          <span></span></li>
        <li><a href="list3.html">论坛</a></li>
        <!--<li><a href="daohang.html">优秀个人博客</a></li>-->
        <li><a href="about.html">关于我</a></li>

	  <span ></span>
	<li class="menu" style="margin-left:450px;"><a href="list2.html">登陆注册</a>
          <ul class="sub">
            <li><a href="/6">登陆</a></li>
            <li><a href="/7">注册</a></li>
